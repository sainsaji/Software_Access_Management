...
namespace File_Acess_Management
{
    ...
    public partial class UserDashBoard : Form
    {
        ...
        private string GetData(string requiredData)
        {
            try
            {
                SqlConnection con = new SqlConnection("Data Source=(LocalDB)\\MSSQLLocalDB;AttachDbFilename=C:\\Users\\Sain.Saji\\Documents\\fileAccessMgmtDB.mdf;Integrated Security=True;Connect Timeout=30");
                con.Open();
        ...
        private void loadSoftwareList()
        {
            ...
            var connection = "Data Source=(LocalDB)\\MSSQLLocalDB;AttachDbFilename=C:\\Users\\Sain.Saji\\Documents\\fileAccessMgmtDB.mdf;Integrated Security=True;Connect Timeout=30";
